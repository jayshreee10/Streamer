...
import { Container, Flex, Kbd, Link, Separator, Text, Box, Badge, Grid, Button } from "@radix-ui/themes";
    ...
    <main className="min-h-screen bg-background">
      ...
      <Box className="border-b border-gray-6 py-3 px-6">
        <Flex align="center" gap="2">
          <Text size="5" weight="bold" className="bg-gradient-to-r from-violet-9 to-indigo-9 bg-clip-text text-transparent">
            LiveStream
          </Text>
      ...
      <Container size="2" className="py-8">
        <Grid columns={{ initial: "1", md: "2" }} gap="8" className="items-center">
          {/* Left side - info */}
          <Flex direction="column" gap="4" className="max-w-md">
            <Text size="8" weight="bold" className="tracking-tight text-gray-12">
              Premium video meetings
            </Text>
            <Text size="3" className="text-gray-11">
              A reliable and secure livestreaming platform for everyone. Start and join broadcasts directly from your browser.
            </Text>
            <Box className="mt-4">
        ...
        <Flex justify="between" align="center">
          <Flex gap="4">
            <Flex align="center" gap="1" className="text-gray-11">
              ...
              <Text size="1">
                Powered by{" "}
                <Link href="https://livekit.io/cloud" target="_blank" rel="noopener noreferrer" className="text-blue-9">
                  LiveKit Cloud
                </Link>
              </Text>
            </Flex>
